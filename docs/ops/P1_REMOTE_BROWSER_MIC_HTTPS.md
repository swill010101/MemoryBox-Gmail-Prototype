...
**Workstream:** Deployment / ops (D7 topology) — **not** Increment 6 Person & Identity
...
- Do **not** expand Increment 6 to implement TLS unless Tom assigns that work to the ops/deploy increment explicitly.

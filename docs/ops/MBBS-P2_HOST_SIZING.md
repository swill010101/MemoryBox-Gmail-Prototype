...
3. Restart Ask/serve.  
4. **P2-I4 ACCEPTED** 2026-08-18. Remaining Explore visual defects are **P2-BL-I4-01**. **MBQL-001** and **P2-I8** are **ACCEPTED**. **P2-I8A** definition is written (not build-authorized).

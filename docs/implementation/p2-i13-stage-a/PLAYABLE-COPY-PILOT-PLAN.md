...
## Single-copy publication approved

Tom explicitly approved publication after the staged visual/audio/seeking pass. Approval reference: `Tom-approved-single-copy-publication-2026-09-05`. Use the existing reviewed helper commit d3e7eff71c8a627bf1f712dfe5c99be493c38992 with --publish and visual reference `Tom-staged-visual-audio-seek-pass-2026-09-05`. Scope remains only vid-c57dbd21f993f6d1 / 20111105_1532.MP4 and the validated output hash ca206513d69bb08f499df0b26a6646e438061dbbdce1579cae48aef643027f90. Publication rechecks and links the existing staged copy at its exact proxy destination; no re-encoding, replacement, deletion, queue processing or service redeployment is authorized or necessary. Publication execution and in-MB playback verification are pending operator output. Stop if the helper reports an error; do not bypass its checks.

## In-MB playback result received

After publication authorization and service restart instructions, Tom reported 15 Gallery fragments/entries for this one source, verified all work, and observed the playhead continuing "seemingly beyond the stop time"; he concluded "they are all good." Record successful in-MB playback of all 15 entries by owner report. This supports the one-source playable-copy pilot; exact relevance-boundary timing was not instrumented, and publication command output/GET readiness evidence and Gallery-return details were not supplied. No further encoding is needed for this source on the basis of this report.

The 15 entries remain a separate presence-interval/Gallery-presentation issue. They are not proof of 15 physical media files or 15 genuine appearances. Recommended next work is a read-only trace of this exact source's observations, exemplar/appearance records, grouping and Gallery items, followed by a bounded correction proposal. Do not delete/merge runtime records, run recognition/Learn, or expand conversion to additional sources under this result. Other source playback and full face/voice acceptance remain outside this pilot's evidence.

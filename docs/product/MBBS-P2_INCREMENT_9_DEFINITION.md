...
Founder locks: local diarization with anonymous speakers; video speech only; Choose Person + Learn on a transcript span; evidence-first retrieval; words / turns / Spoken Moments distinct; I8B videos as the controlled acceptance subset; face ranges optional context only.

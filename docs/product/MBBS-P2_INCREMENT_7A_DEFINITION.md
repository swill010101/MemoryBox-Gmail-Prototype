...
**I7A ACCEPTED.** Keep `/dev/ai-trace` off when not diagnosing; emission stays on for later increments. MBQL-001 **ACCEPTED** 2026-08-18. **P2-I8 ACCEPTED** 2026-08-18. **P2-I8A definition is written** (not build-authorized).

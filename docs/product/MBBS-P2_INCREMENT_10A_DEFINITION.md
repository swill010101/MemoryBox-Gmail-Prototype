...
**After I10A:** **I10A.1** Person Profile and Editor ([PRD](MBPRD-P2-I10A1_PERSON_PROFILE_EDITOR.md) **ACCEPTED** · [screen contract](MBSC-P2-I10A1_PERSON_SCREEN_CONTRACT.md)) → **I10A.2** Unified Voice Capture (Stories first) → I10B Artifacts (**ACCEPTED** 2026-08-23) → **I10C Journal**. I10A dictation lock stands until I10A.2.

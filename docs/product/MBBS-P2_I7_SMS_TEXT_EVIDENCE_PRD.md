...
Tom authorized build 2026-08-14 (“approved to build”). **ACCEPTED** 2026-08-15 (Tom: “i7 is accepted”). SMS attachment **bytes** are **P2-BL-I7-01** — do not reopen I7. I8 email ingest must include attachment files up front (**P2-BL-I8-01**). Next increment: [I7A](MBBS-P2_INCREMENT_7A_DEFINITION.md) definition locked; no I7A build until explicit authorization.

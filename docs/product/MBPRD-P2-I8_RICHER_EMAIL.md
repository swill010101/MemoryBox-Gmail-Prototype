...
Definition §7 — **shipped**. Increment **ACCEPTED** 2026-08-18. Unified comms UX is **I8A** (definition written; not this PRD; not build-authorized).
...
PRD **LOCKED**. Definition **LOCKED**. Build **shipped**. **ACCEPTED** 2026-08-18. Unified comms UX is **[I8A](MBBS-P2_INCREMENT_8A_DEFINITION.md)** (definition written; not build-authorized). Ask first-name Peggy count without locking Peggy George is **P2-BL-I8-02** (next increment; does not reopen I8).

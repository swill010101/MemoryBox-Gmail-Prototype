...
**Status:** Living parking note · **Updated:** 2026-08-24 (I10C Journal definition **DRAFT**)  
...
**P2-I10A.2 Reusable Speech Input** — [PRD](MBPRD-P2-I10A2_SPEECH_INPUT.md) · [screen contract](MBSC-P2-I10A2_SPEECH_SCREEN_CONTRACT.md) · [acceptance](MBAT-P2-I10A2_ACCEPTANCE.md). **ACCEPTED** 2026-08-24 (Tom: “i10A.2 is accepted”). Shared narrative editor; authored-memory vs convenience. `prove-i10a2` remains the regression gate. Do not reopen.
...
**Next:** **I10C Journal** — definition **DRAFT** (not locked, not build-authorized): [MBBS-P2_INCREMENT_10C_DEFINITION.md](MBBS-P2_INCREMENT_10C_DEFINITION.md) · field verification [MBAS-P2-I10C_ASSESSMENT_RECONCILIATION.md](MBAS-P2-I10C_ASSESSMENT_RECONCILIATION.md). I10A.2 **ACCEPTED** 2026-08-24. Do not reopen I10A.2. **I11 is not authorized** until I10A + I10A.1 + I10A.2 + I10B + I10C and required transcription/recognition work. Face-SoT (**I8.5**) **later**. **P2-I4 ACCEPTED**; Explore visual polish is **P2-BL-I4-01**. **ACR-P2-001** is parked and is not I10. Do not reopen I10A.1.

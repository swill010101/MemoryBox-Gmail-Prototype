...
**P2-I10A Stories** — [definition](MBBS-P2_INCREMENT_10A_DEFINITION.md) · [PRD](MBPRD-P2-I10A_STORIES.md). **BUILD AUTHORIZED** 2026-08-21. **Not I11.** Next: **I10B Artifacts**, **I10C Journal**.
...
**Next after I10 ACCEPTED:** **P2-I10A Stories** (this slice) then **I10B Artifacts** then **I10C Journal**. **I11 is not authorized** until those three HVRT→MB conversions are done. Face-SoT (**I8.5**) **later**. **P2-I4 ACCEPTED**; Explore visual polish is **P2-BL-I4-01**. **ACR-P2-001** is parked and is not I10.

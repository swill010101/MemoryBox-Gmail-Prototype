...
| **P2-I10B** | Artifacts | U+F | [definition](MBBS-P2_INCREMENT_10B_DEFINITION.md) · [PRD](MBPRD-P2-I10B_ARTIFACTS.md) — **build-authorized 2026-08-23**, implementing. Tell its story uses shared Story editor; recorder is I10A.2. |
...
HVRT→MB Artifacts conversion. [definition](MBBS-P2_INCREMENT_10B_DEFINITION.md) · [PRD](MBPRD-P2-I10B_ARTIFACTS.md) · [assessment](MBAS-P2-I10B_ASSESSMENT_RECONCILIATION.md). Screens: `fe913a4` in `MBUX Story Screens/`. **Build-authorized 2026-08-23; implementing.** Tell its story opens `/story/ui?new=1&artifact=` (no Artifact MediaRecorder). Sequence remains I10A → I10A.1 → I10A.2 (Stories first) → I10B → I10C → I11. Implementation branch: `cursor/p2-i10b-artifacts-49da`.

...
| **P2-I11** | Narrative & Summaries | E+A | **BUILD AUTHORIZED** 2026-08-24 (Tom: “i11 next”) — [I11 assessment](MBAS-P2-I11_NARRATION_LIVING_VIEW_ASSESSMENT.md) · [definition](MBBS-P2_INCREMENT_11_DEFINITION.md) · [PRD](MBPRD-P2-I11_NARRATION.md). Ask `output_mode`; no new screen. Save View/Living View persistence is **I13**. `prove-i11`. |
...
P2-NAR-01..03. Review before durable save. Narration is Explore/Ask `output_mode=tell`, not a new app. [assessment](MBAS-P2-I11_NARRATION_LIVING_VIEW_ASSESSMENT.md) · [PRD](MBPRD-P2-I11_NARRATION.md). **BUILD AUTHORIZED** 2026-08-24 (Tom: “i11 next”). I13 owns Save View persistence.

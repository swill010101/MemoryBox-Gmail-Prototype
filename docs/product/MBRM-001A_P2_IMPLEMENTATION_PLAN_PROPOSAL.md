...
| **P2-I12** | Historian Collection & Campaigns V1 | E+A | **ACCEPTED** 2026-09-04 (Tom: “i12 is accepted”) — [MBRM-001B](MBRM-001B_P2_HISTORIAN_COLLECTION_AND_CAMPAIGNS.md) · [definition](MBBS-P2_INCREMENT_12_DEFINITION.md) · [PRD](MBPRD-P2-I12_HISTORIAN_COLLECTION_CAMPAIGNS.md) · [acceptance](MBAT-P2-I12_ACCEPTANCE.md). `prove-historian-capture`. Do not reopen. |
| *(deferred)* | External Historical Context (EVS-254–256) | E | Was MBRM-001A P2-I12 row — schedule separately |
| **P2-I13** | Dynamic Views | U | |
| **P2-I14** | Settings & Processing Controls | U | No confidence dials |
| **P2-I15** | Owner-run Capture Campaigns | E | **Absorbed into P2-I12** (ACCEPTED 2026-09-04) |
...
Shared typed intent for Planner / Orchestrator / Explore commands. **ACCEPTED** 2026-08-18 (Tom: “MBQL is accepted”). [definition](MBBS-P2_INCREMENT_MBQL_001_DEFINITION.md) · [PRD](MBPRD-P2-MBQL-001_ASK_QUERY_COMMAND_LANGUAGE.md). Q1 residual model only. **P2-I8 ACCEPTED** (2026-08-18). **P2-I8A ACCEPTED** (2026-08-19). Near-term: **I9** (not authorized). I8.5 later.

### P2-I8 — Richer Email · A

P2-COM-02/03. **ACCEPTED** 2026-08-18 (Tom FlightSim §9). [I8 definition](MBBS-P2_INCREMENT_8_DEFINITION.md). Attachment files up front = **P2-BL-I8-01** (absorbed). Ask first-name Peggy count without locking Peggy George = **P2-BL-I8-02** (**absorbed in I8A ACCEPTED**).

### P2-I8A — Unified Communications Gallery & Timeline Precision · U

Combined Email/SMS/Calendar **day** cards, density-aware aggregation, Communications + Calendar filters, Attachments only, drill-down (rollover → Open Day → tabs), shared viewer without send, Q3 visual-off defaults, **P2-BL-I8-02**. [I8A definition](MBBS-P2_INCREMENT_8A_DEFINITION.md) **ACCEPTED** 2026-08-19. Next is **I9** (not authorized). Not I8.5. Not I10/I11 generation.

### P2-I8.5 — Face Evidence Ownership · F

Existing inserted increment (Immich decoupling). **Moved later** (founder I8A Q1): after photo/video recognition, correction, merge/review, and relearning are operationally solid. Not next after I8A.
...
P2-GRAPH-02/03. **ACCEPTED** 2026-08-21 (Tom: “i10 has been accepted”). Mixed evidence pack for everything-about; coverage + gaps; reject sticks; date conflicts disclosed. Not I11 narrative. [I10 definition](MBBS-P2_INCREMENT_10_DEFINITION.md).
...
Shared narrative field, then speech with two semantics (authored-memory preserves audio on Save; convenience is transient). [PRD](MBPRD-P2-I10A2_SPEECH_INPUT.md) · [assessment](MBAS-P2-I10A2_ASSESSMENT_RECONCILIATION.md). **ACCEPTED** 2026-08-24 (Tom: “i10A.2 is accepted”). Do not reopen.

### P2-I10B — Artifacts · U+F

HVRT→MB Artifacts conversion. [definition](MBBS-P2_INCREMENT_10B_DEFINITION.md) · [PRD](MBPRD-P2-I10B_ARTIFACTS.md). **ACCEPTED** 2026-08-23. Tell its story opens `/story/ui?new=1&artifact=`. Implementation: `cursor/p2-i10b-artifacts-49da`.

### P2-I10C — Journal · U+F

[I10C definition](MBBS-P2_INCREMENT_10C_DEFINITION.md) **ACCEPTED** 2026-08-24 (Tom: “i10C - journal is accepted”). Family chrome on the existing I5A store; HVRT ingest **out**. Drafts IN; Ask uses last saved until Save journal. Same I10A.2 speech. Do not reopen Journal screens.

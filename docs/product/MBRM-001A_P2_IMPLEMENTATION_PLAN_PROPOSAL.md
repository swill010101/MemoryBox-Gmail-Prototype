...
**Gate:** Increment builds require explicit definition + build authorization (I1–I3, I5, I6 **ACCEPTED**; I4 build authorized / not ACCEPTED; I7 **BUILD AUTHORIZED** / not ACCEPTED; **P2-I7A drafted for review — no build** until I7 ACCEPTED + explicit I7A authorization).  
...
| **P2-I7A** | AI Model Trace & Observability | F | **DRAFTED FOR REVIEW / NO BUILD** — after I7 ACCEPTED, before MBQL-001 — [I7A definition](MBBS-P2_INCREMENT_7A_DEFINITION.md) |
...
Developer-only request→model→disposition traces. **No build** until I7 ACCEPTED + explicit authorization. [I7A definition](MBBS-P2_INCREMENT_7A_DEFINITION.md). **MBQL-001 waits on I7A.**

# MBPRD-P2-STORIES — Stories Vertical Slice

**Status:** PRD **DRAFT — awaiting owner sign-off** · **not build-authorized**  
**Date:** 2026-08-21  
**Kind:** Planning only. No runtime, schema, or cherry-pick in this increment of work.

**Visual baseline (do not copy onto I10):** commit `c95117b` on `origin/cursor/marvin-capture-v01-3344`
...
**Increment ID:** **Open.** This is **not** I11. I11 remains evidence-backed narrative synthesis (EVS-181/182). This PRD is the human Story object (EVS-172–180 plus rail/picker). Tom assigns the increment number at sign-off.

...
I10 **joins** already-ingested evidence into owner-correctable **Event / Trip** Occurrences. **Place is an anchor**, not an Occurrence type. Membership retains I9 Spoken Moment time bounds. Discovery → durable membership → retrieval (not a fresh fuzzy OR). It does not reopen I8B/I9/I8A, does not cartesian people × videos, and does not generate trip narratives.

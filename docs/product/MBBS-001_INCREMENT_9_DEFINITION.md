...
**Status:** **ACCEPTED** (FlightSim owner gate 2026-08-11)  
**Date:** 2026-08-10  
...
**Authorization:** *Build Increment 9 only* — **authorized, shipped, and accepted**. 9A/10 not authorized.
...
Do **not** begin Increment 9A / 10 / Guided Capture / Export under I9 authorization — 9A requires *Build Increment 9A only*.
...
*End of Increment 9 definition — ACCEPTED.*

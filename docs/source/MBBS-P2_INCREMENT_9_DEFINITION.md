...
**Version:** v1.1  
**Status:** **HOLD FOR APPROVAL** — founder locks ingested 2026-08-19; definition **not** locked until Tom approves this file; runtime **NOT build-authorized**  
...
**Roadmap placement:** After **P2-I8A** (ACCEPTED 2026-08-19) and **P2-I8B** Person-Seeded Video Recognition & Learning. **I9 runtime build begins only after P2-I8B is founder ACCEPTED.** I8.5 Face-SoT stays later.

## Founder locks (2026-08-19)

These are product locks. They do not authorize runtime implementation.

1. **I8B gate.** I9 runtime build begins only after P2-I8B is founder ACCEPTED.
...
This v1.1 file is **held for founder approval**. It is not locked and does **not** authorize runtime work.

Runtime implementation, schema migration, or UX modification does not begin until **all** of the following are true:

1. Tom **approves this v1.1 definition** (or a successor) as the authoritative I9 source.
2. **P2-I8B is founder ACCEPTED.**
3. Tom **explicitly authorizes the I9 build.**

I8A ACCEPTED does not satisfy (2) or (3).

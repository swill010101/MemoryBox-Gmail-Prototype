...
ASK_ROLE_ALIASES: dict[str, frozenset[str]] = {
    ...
    "grandpa": frozenset({ROLE_GRANDPARENT_OF}),
    "grandma": frozenset({ROLE_GRANDPARENT_OF}),
    "nana": frozenset({ROLE_GRANDPARENT_OF}),
    "grammy": frozenset({ROLE_GRANDPARENT_OF}),
    "gram": frozenset({ROLE_GRANDPARENT_OF}),
